...
/// <summary>
/// Settable implementation of IActiveGroupContext and IBoardTypeResolver for integration tests.
/// Defaults to GroupId = 1 (EuphoriaInn seed group). Tests override as needed.
/// Registered as Singleton (under both interfaces) in WebApplicationFactoryBase so test code
/// can mutate it directly.
/// </summary>
public class MutableGroupContext : IActiveGroupContext, IBoardTypeResolver
{

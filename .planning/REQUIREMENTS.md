...
- [ ] **EVTAVAIL-04**: A member who joins a Campaign board after events already exist is auto-signed-up to every event dated today or later, and a member who leaves has all of their event signups on that board removed — past and future, automatic and deliberate

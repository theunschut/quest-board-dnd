...
- [x] **CONTACTTAG-17**: The tag filter is applied before any contact grouping step, so a later category-heading pass groups the already-filtered set and empty headings drop out without a second rendering mode
...
| QUESTFEED-13 | Phase 85 | Pending |
| QUESTFEED-14 | Phase 85 | Pending |

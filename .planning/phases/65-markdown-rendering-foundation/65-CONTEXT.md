...
- **D-02:** The toolbar UI stays **curated** to what's genuinely useful for this app's domain (already locked at the milestone level: Bold/Italic/Heading/List/Link/Blockquote, plus Strikethrough per D-03) — the parser supporting more syntax than the toolbar exposes is intentional, not an oversight. Power users get full expressiveness; casual users get a focused button set.

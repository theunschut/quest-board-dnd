...
| 61. Allow DMs to edit finalized quest details | v7.0 | 1/2 | In Progress|  |
...
- [x] 61-01-PLAN.md — Wave-0 failing integration tests (QuestFinalizedEditTests): finalized Edit GET returns 200, Proposed Dates hidden desktop+mobile, non-finalized regression guard, D-01 player-count floor guard, no-roster-wipe on valid edit, Edit Quest link on Manage desktop+mobile

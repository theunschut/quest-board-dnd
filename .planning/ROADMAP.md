...
- [x] 34.3-04-PLAN.md — `Admin/AccountController` Profile/Edit badges migrated + `IActiveGroupContext` injected (D-04 fail-soft null-group)

**Wave 3** *(blocked on 34.3-02, 34.3-03, 34.3-04, 34.3-05)*

- [x] 34.3-06-PLAN.md — D-05 regression integration tests across all six site groups (QuestController new file + QuestLog/DungeonMaster/Account/Admin extensions, incl. fail-soft null-group + Hangfire deny + AdminResetPassword end-to-end) + full-suite gate

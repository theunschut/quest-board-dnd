...
- [x] 39-01-PLAN.md — Shared collision-aware CreateOrAddToGroupAsync Domain method + result type, with unit coverage of all four outcomes
- [x] 39-02-PLAN.md — AddedToGroup email component + Hangfire job, RedirectWithWarning helper, and Users.cshtml warning banner
...
- [x] 40-01-PLAN.md — Backend seam: GetAvailableUsers not-in-group + search query (repository/service/interfaces), CreateMemberViewModel, reshaped GroupMembersViewModel
...
**Goal:** [To be planned] — deferred idea from Phase 39 discussion: convert all flash messages app-wide from static alert banners to Bootstrap toast notifications, matching the Shop view's existing local toast pattern (`Views/Shop/Index.cshtml`).
**Requirements**: TBD
**Depends on:** Phase 41
**Plans:** 0 plans

...
- [ ] 68-01-PLAN.md — Wire the Markdown editor into Character Description + Backstory on all 4 write forms (incl. the full-path `_QuestFormScripts` include) + global editor-color specificity fix
- [ ] 68-02-PLAN.md — Render Description + Backstory as HTML on Character Details (desktop + mobile) + mobile list-item color fix
...
| 68. Character Fields | v8.0 | 0/3 | Not started | - |
